...
public class BautistasDomain extends Level {
	...
	protected void initMapTransporters() {
		this.addEntity(new MapTransporter(this, 0, 0,
				Game.levels.lordHillsboroughsDomain, Direction.NORTH,
				(this.width * 8), 8));
		this.addEntity(new MapTransporter(this, 0, (this.height * 8) - 8,
				Game.levels.techTopia, Direction.SOUTH, (this.width * 8), 8));
		this.addEntity(new MapTransporter(this, 0, 0,
				Game.levels.edgeOfTheWoodsMain, Direction.WEST, 8,
				this.height * 8, Game.levels.edgeOfTheWoodsMain.height * 8.0 / 3));
