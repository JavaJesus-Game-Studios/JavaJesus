...
public class Launcher extends JFrame implements Runnable {
	...
	public static final Level level = null;
	...
	private void doAction() {
		...
		case SURVIVAL: {
			...
			new Display(GameMode.SURVIVAL, false);
			this.stop();
			return;
		}
		case ZOMBIES: {
			SoundHandler.background1.stop();
			new Display(GameMode.MINI, false);
			this.stop();
			return;
		}
		case BACK: {
		...
		case NEWSTORY: {
			SoundHandler.background1.stop();
			new Display(GameMode.ADVENTURE, false);
			this.stop();
			return;
		}
		case CONTINUESTORY: {
			SoundHandler.background1.stop();
			new Display(GameMode.ADVENTURE, true);
			this.stop();
			return;
		}
		case MUTE: {
