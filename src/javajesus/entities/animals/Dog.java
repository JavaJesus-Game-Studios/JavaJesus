...
public class Dog extends Animal {
	...
	private Render2x2 renderDog = new Render2x2();
	...
	public Dog(Level level, int x, int y) {
		super(level, "Dog", x, y, 16, 16, SpriteSheet.quadrapeds, 8, color, true);
	}
	...
	public void render(Screen screen) {
		...
		if( isLatitudinal())
			renderDog.renderNormal(screen, xCoordinate, yCoordinate, xTile, yTile, flip, getSpriteSheet(), color);
		if( isLongitudinal())
			renderDog.renderNormal(screen, xCoordinate, yCoordinate, xTile, yTile, false, getSpriteSheet(), color);
	}
