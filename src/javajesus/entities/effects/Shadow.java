...
public class Shadow {
	 ...
	 * @param isChild determines whethter to use the child shadow sprite
	 */
	public Shadow(Level level, int width, boolean isDead, boolean isChild) {
	 ...
	 * @param width the width of the entity's collision box, used to determine shadow sprite
	 */
	public Shadow(Level level, int width) {
	...
	public void render(Screen screen, int x, int y) {
		...
		screen.renderBlend(x, y, shadowColor, alpha, sprite);
	}
	/**
	...
	public void setSprite(int width, boolean isDead, boolean isChild) {
		switch( width ) {
			...
			case (TILE_SIZE * 4):
				...
				// This sprite is taller than the rest
				break;
			default:
				sprite = Sprite.SHADOW_2X2;
		}
