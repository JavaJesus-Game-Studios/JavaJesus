...
public abstract class Entity implements Serializable {
	...
	public static final byte DESTRUCTIBLE_TILE = 0, FIRE_ENTITY = 1, GAUCHO = 2, SPAWNER = 3, CENTAUR = 4, CYCLOPS = 5,
            ...
            WEIRD_TECH_BUILDING2 = 76, BED = 77, BENCH = 78, POOL_TABLE = 79, CHAIR_SIDE = 80, CHEST = 81,
            ...
            COW = 104, FOX = 105, DOG = 106, CAT = 107, PANCHOMBRE = 108, BANDITO = 109, SKELETON = 110, BAR = 111,
            CARD_TABLE = 112, DEAD_SEQUOIA_SMALL = 113;
