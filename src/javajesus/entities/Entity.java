...
public abstract class Entity implements Serializable {
	...
	public static final byte DESTRUCTIBLE_TILE = 0, FIRE_ENTITY = 1, GAUCHO = 2, SPAWNER = 3, CENTAUR = 4, CYCLOPS = 5,
	        ...
	        GUNSTORE = 37, HOTEL = 38, HUT = 39, MINESHAFT = 40, NICE_HOUSE = 41, NICE_HOUSE2 = 43, POLICE = 44,
	        POOR_HOUSE = 45, PRISON = 46, PROJECTS = 47, RANCHERO_HOUSE = 48, REFUGEE_TENT = 49,
	        RUSSIAN_ORTHODOX_CHURCH = 50, SHANTY_HOUSE = 51, SKYSCRAPER = 52, TIPPEE = 53, WAREHOUSE = 54,
	        GREAT_TREE = 55, TREE_HOUSE = 56, UC_GRIZZLY = 57, OAKWOOD_CITY_HALL = 58, CHINATOWN_HOUSE = 59,
	        RUSSIAN_CLUB = 60, SAN_CISCO_CITY_HALL = 61, SAN_CISCO_SKYSCRAPER = 62, TRIAD_HQ = 63, JUNGLE_HQ = 64,
	        QUACKER_HQ = 65, SAN_JUAN_CITY_HALL = 66, THE_HUB = 67, SEQUOIA_CINEMA = 68, SEQUOIA_SCHOOL = 69, CAFE = 70,
	        CARDINAL_UNIVERSITY = 71, PEAR_HQ = 72, RADAR_DISH = 73, TECHTOPIA_CITY_HALL = 74,
	        WEIRD_TECH_BUILDING1 = 75, WEIRD_TECH_BUILDING2 = 76, BED = 77, BENCH = 78, POOL_TABLE = 79,
	        CHAIR_SIDE = 80, CHEST = 81, COMPUTER_MONITOR = 82, COMPUTER_TOWER = 83, DINING_TABLE = 84,
	        FILING_CABINET = 85, LONG_TABLE = 86, NIGHTSTAND = 87, SOFA = 88, SQUARE_TABLE = 89, STOOL = 90,
	        TELEVISION = 91, THRONE = 92, DEAD_SEQUOIA = 93, GENERIC_TREE = 94, LARGE_SEQUOIA = 95, MEDIUM_SEQUOIA = 96,
	        SMALL_SEQUOIA = 97, BOAT = 98, CENTURY_LESABRE = 99, HORSE = 100, SPORTS_CAR = 101, TRUCK = 102,
	        MODERN_SKYSCRAPER = 103, COW = 104, FOX = 105, DOG = 106, CAT = 107, PANCHOMBRE = 108, BANDITO = 109,
	        SKELETON = 110, BAR = 111, CARD_TABLE = 112, DEAD_SEQUOIA_SMALL = 113, DEAD_SEQUOIA_MEDIUM = 114,
	        REDWOOD_LARGE = 115, REDWOOD_MEDIUM = 116, REDWOOD_SMALL = 117, SEQUOIA_EXTRA_LARGE = 118,
	        SEQUOIA_EXTRA_SMALL = 119, SMALL_TREE_AUTUMN = 120, SMALL_TREE_WINTER = 121, MEDIUM_TREE = 122,
	        MEDIUM_TREE_AUTUMN = 123, MEDIUM_TREE_WINTER = 124, LARGE_TREE = 125, LARGE_TREE_AUTUMN = 126,
	        LARGE_TREE_WINTER = 127, WHITE_OAK = -128, WHITE_OAK_SMALL = -127;
