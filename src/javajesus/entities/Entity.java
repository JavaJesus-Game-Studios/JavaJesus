...
public abstract class Entity implements Serializable {
	...
	public static final byte DESTRUCTIBLE_TILE = 0, FIRE_ENTITY = 1, GAUCHO = 2, SPAWNER = 3, CENTAUR = 4, CYCLOPS = 5,
	        ...
	        MODERN_SKYSCRAPER = 103, COW = 104, FOX = 105, DOG = 106, CAT = 107, CHICKEN = 108, DUCK = 109, PIGEON = 110,
			PANCHOMBRE = 111, BANDITO = 112,SKELETON = 113, BAR = 114, CARD_TABLE = 115, DEAD_SEQUOIA_SMALL = 116, DEAD_SEQUOIA_MEDIUM = 117,
	        ...
	        ORANGUTAN=-122, ALPHA_CAVE_ENTRANCE=-121,EVIL_ORANGUTAN=-120,STORYTELLER=-119,GRASS_GREEN=-118,GRASS_GOLD=-117,CHUNGUS=-116;
