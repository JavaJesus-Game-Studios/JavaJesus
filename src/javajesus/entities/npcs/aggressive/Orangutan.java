...
public class Orangutan extends NPC {
	...
	/**
	 * Creates a generic Orangutan with different abilities
	 ...
	 */
	public Orangutan(Level level, int x, int y, int defaultHealth, String walkPath, int walkDistance) {
		super(level, "Orangutan", x, y, 1, WIDTH, HEIGHT, defaultHealth, new int[] { 0xFF111111, 0xFF000046, 0xFFEDC5AB },
				0, 50, walkPath, walkDistance);
	 ...
	 * @param y the y coord
	 */
	public Orangutan(Level level, int x, int y) {
	...
	/**
	 * Displays the Orangutan on the screen
	 */
	...
	/**
	 * Speech options for Orangutan
	 */
	public void doDialogue() {
		MessageHandler.displayText(getName() + ": Orangutan like human.", Color.white);
		return;
	}
