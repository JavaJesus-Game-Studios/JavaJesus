...
public class Forest {
	 ...
	 */
	private static final boolean checkTile(Level level, int x, int y) {
	 ...
	 * @param x - the left corner of the forest
	 * @param y - the upper bound of the forest
