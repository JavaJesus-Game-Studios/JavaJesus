...
public class Item implements Serializable {
	...
	public static final Item shortSword = new Sword("Cutlass", 9, 0, 1, 0, 0,
			...
			+ "a good sting.",
			15, 10, new int[] { 7, 12, 16, 21 }, 0, Sword.SHORT, 0);
