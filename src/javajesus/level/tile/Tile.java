...
public class Tile {
	...
	/////// NATURAL ////////
		...
		//Grass
		public static final Tile GRASS = new Tile(2, false, 0xFF00FF00, 0, 1, SpriteSheet.tiles, 
				new int[] { 0xFF339933, 0xFF33BB33, 0xFF000000 });
		public static final Tile GRASS_FLOWER = new Tile(16, false, 0xFF15DF00, 5, 1, SpriteSheet.tiles,
				new int[] { 0xFF339933, 0xFF33BB33, 0xFFFFFFFF });
		public static final Tile GRASS2 = new Tile(17, false, 0xFF00FF00, 1, 1, SpriteSheet.tiles, 
				new int[] { 0xFF339933, 0xFF33BB33, 0xFF000000 });
		public static final Tile GRASS3 = new Tile(18, false, 0xFF00FF00, 4, 1, SpriteSheet.tiles, 
				new int[] { 0xFF339933, 0xFF33BB33, 0xFF000000 });
		public static final Tile GRASS_POPPY = new Tile(54, false, 0xFF00FF00, 16, 1, SpriteSheet.tiles,
				new int[] { 0xFF339933, 0xFF33BB33, 0xFF000000 });
		public static final Tile GRASS4 = new Tile(62, false, 0xFF00FF00, 19, 1, SpriteSheet.tiles, 
				new int[] { 0xFF339933, 0xFF33BB33, 0xFF000000 });
		public static final Tile GRASS5 = new Tile(63, false, 0xFF00FF00, 20, 1, SpriteSheet.tiles, 
				new int[] { 0xFF339933, 0xFF33BB33, 0xFF000000 });
		
		public static final Tile FARMPLOT1 = new Tile(12, false, 0xFF1E6A00, 2, 1, SpriteSheet.tiles,
				new int[] { 0xFF0C6600, 0xFF5D3102, 0xFF000000 });
		public static final Tile FARMPLOT2 = new Tile(13, false, 0xFF123F00, 3, 1, SpriteSheet.tiles,
				new int[] { 0xFF0C6600, 0xFF5D3102, 0xFF000000 });
	

		//DIRT
		public static final Tile SAND = new Tile(4, false, 0xFFFFFF00, 9, 2, SpriteSheet.tiles,
				new int[] { 0xFFEEBB00, 0xFFFFFF00, 0xFF000000 });
		
		public static final Tile MUD = new Tile(11, false, 0xFF372201, 0, 2, SpriteSheet.tiles,
				new int[] { 0xFF2c1802, 0xFF000000, 0xFF000000 });
		public static final Tile DIRTROAD = new Tile(14, false, 0xFFA06201, 10, 2, SpriteSheet.tiles,
				new int[] { 0xFF935409, 0xFF000000, 0xFF000000 });
	
		public static final Tile CAVEFLOOR = new Tile(20, false, 0xFFC3BEB7, 0, 2, SpriteSheet.tiles,
		...
		public static final Tile CAVEWALL = new Tile(19, true, 0xFF291900, 4, 0, SpriteSheet.tiles, 
	...
	/////// URBAN ////////
		...
		//ROADS
		public static final Tile ROAD1 = new Tile(6 ,false, 0xFF565656, 0, 2, SpriteSheet.tiles,
				new int[] { 0xFF222222, 0xFF353535, 0xFF000000 });
			//(Sidewalk)
		public static final Tile ROAD2 = new Tile(7, false, 0xFF3f3f3f, 1, 2, SpriteSheet.tiles,
				new int[] { 0xFFa7a7a7, 0xFF3c3c3c, 0xFF000000 });
		public static final Tile ROAD3 = new Tile(9, false, 0xFF9b9b9b, 2, 2, SpriteSheet.tiles,
				new int[] { 0xFFa7a7a7, 0xFF3c3c3c, 0xFF000000 });
	
		public static final Tile BRICKROAD = new Tile(15, false, 0xFFA50000, 1, 0, SpriteSheet.tiles,
				new int[] { 0xFFD40000, 0xFFB40000, 0xFF000000 });
	
	
		public static final Tile VOID = new Tile(0, true, 0xFF000000, 0, 0, SpriteSheet.tiles,
	...
	/////// INTERIOR //////
		...
		//Floors
		public static final Tile WOODFLOOR = new Tile(21, false, 0xFF944500, 6, 0, SpriteSheet.tiles, 
				new int[] { 0xFF753003, 0xFF291900, 0xFF000000 });
		public static final Tile STONE = new Tile(1, true, 0xFF555555, 1, 0, SpriteSheet.tiles,
				new int[] { 0xFF7F7F7F, 0xFFC3C3C3, 0xFF000000 });
		public static final Tile RIGHTCARPET = new Tile(23, false, 0xFFBE03DB, 7, 1, SpriteSheet.tiles,
				new int[] { 0xFFA40101, 0xFFEBCB00, 0xFF000000 });
		public static final Tile LEFTCARPET = new Tile(24, false, 0xFFEC00EC, 6, 1, SpriteSheet.tiles, 
				new int[] { 0xFFA40101, 0xFFEBCB00, 0xFF000000 });
		public static final Tile TOPCARPET = new Tile(26, false, 0xFFFF00FF, 9, 1, SpriteSheet.tiles,
				new int[] { 0xFFA40101, 0xFFEBCB00, 0xFF000000 });
		public static final Tile BOTTOMCARPET = new Tile(27, false, 0xFF6600A7, 8, 1, SpriteSheet.tiles, 
				new int[] { 0xFFA40101, 0xFFEBCB00, 0xFF000000 });
		public static final Tile CHECKERED_TILE = new Tile(49, false, 0xFFe3350c, 11, 1, SpriteSheet.tiles,
				new int[] { 0xFF111111, 0xFF111111, 0xFFFFFFFF });
		public static final Tile FLOOR_CARPET_1 = new Tile(46, false,0xFF1f7a01,10, 1, SpriteSheet.tiles,
				new int[] { 0xFF1F7901, 0xFF1F4001, 0xFF000000 });
		public static final Tile LINOLEUM = new Tile(47, false, 0xFFFFFFFF, 11, 2, SpriteSheet.tiles,
	...
	/////// CURRENTLY UNASSIGNED/MAY DELETE ///////
	public static final Tile METALWALL = new Tile(22, true, 0xFFB6B6B6, 5, 0, SpriteSheet.tiles,
			new int[] { 0xFFA6A6A6, 0xFF939393, 0xFF4B3618 });
