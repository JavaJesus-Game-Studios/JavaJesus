...
public class Animation {
	...
	public void renderAnimation(Screen screen, int xLocation, int yLocation, int[] frames, int yTile,
		...
		if( tickCount % rate == 0 ) {
			...
			// Render the frame
			renderFrame(screen, xSize, ySize, xLocation, yLocation, xTile, yTile, sheet, color);
	...
	private void renderFrame(Screen screen, int xSize, int ySize, int xLocation, int yLocation, int xTile, int yTile, 
		...
		if( xSize == 1 && ySize == 1 )
			render1x1.renderNormal(screen, xLocation, yLocation, xTile, yTile, false, sheet, color);
		if( xSize == 2 && ySize == 2 )
			render2x2.renderNormal(screen, xLocation, yLocation, xTile, yTile, false, sheet, color);
		if( xSize == 2 && ySize == 3 )
			render2x3.renderNormal(screen, xLocation, yLocation, xTile, yTile, false, sheet, color);
		if( xSize == 2 && ySize == 4 )
			render2x4.renderNormal(screen, xLocation, yLocation, xTile, yTile, false, sheet, color);
		if( xSize == 3 && ySize == 3 )
			render3x3.renderNormal(screen, xLocation, yLocation, xTile, yTile, false, sheet, color);
		if( xSize == 3 && ySize == 4 )
			render3x4.renderNormal(screen, xLocation, yLocation, xTile, yTile, false, sheet, color);
		if( xSize == 4 && ySize == 2 )
			render4x2.renderNormal(screen, xLocation, yLocation, xTile, yTile, false, sheet, color);
		if( xSize == 4 && ySize == 4 )
			render4x4.renderNormal(screen, xLocation, yLocation, xTile, yTile, false, sheet, color);
