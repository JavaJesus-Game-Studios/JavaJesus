...
import engine.utility.ShaderUtils;
...
public class Shader {
	...
	public static void loadAll() {
		TILES = new Shader("src/javajesus/shaders/bg.vert", "src/javajesus/shaders/bg.frag");
		PLAYER = new Shader("src/javajesus/shaders/player.vert", "src/javajesus/shaders/player.frag");
	}
