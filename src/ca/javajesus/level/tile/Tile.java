...
public abstract class Tile {
    ...
    public static final Tile VOID = new BasicSolidTile(0, 0, 0, Colors.get(
            000, -1, -1, -1), 0xFF000000);
    public static final Tile STONE = new BasicSolidTile(1, 1, 0, Colors.get(
    ...
    public static final Tile WATERSAND = new AnimatedTile(8, new int[][] {
            ...
            Colors.get(-1, Colors.toHex("#DBEDD2"), 115, -1), 0xFF64FFFF,
            1000);
    ...
    public static final Tile FIRE = new AnimatedTile(5, new int[][] { { 0, 15 },
            ...
            { 1, 15 } }, Colors.get(Colors.toHex("#F51F07"),
