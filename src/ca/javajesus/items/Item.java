...
public class Item {
	...
	public static Item apple = new Item("Apple", 0, 0, 5, Colors.get(-1, 200,
			200, Colors.fromHex("#FF0000")), "This is a red fruit!");
	public static Item banana = new Item("Banana", 1, 0, 5, Colors.get(-1, 300,
			300, Colors.fromHex("#FF0000")), "Monkey like.");
	public static Item orange = new Item("Orange", 2, 0, 5, Colors.get(-1, 400,
			400, Colors.fromHex("#FF0000")), "Orange you glad I said banana.");
	public static Item feather = new Item("Feather", 3, 0, 5, Colors.get(-1,
	...
	public static Item revolver = new Gun("Revolver", 4, 0, 0, Colors.get(-1,
			...
			10, 20, 50);
	public static Item laserRevolver = new Gun("Laser Revolver", 5, 0, 1,
			Colors.get(-1, 500, 500, Colors.fromHex("#FF0000")),
			"Standard Firearm", 1, 0, 10, 10, 20, 2);
	public static Item shotgun = new Gun("Shotgun", 6, 0, 2, Colors.get(-1,
			500, 500, Colors.fromHex("#FF0000")), "Standard Firearm", 2, 4, 5,
			10, 20, 2);
	public static Item assaultRifle = new Gun("Assault Rifle", 7, 0, 3,
			Colors.get(-1, 500, 500, Colors.fromHex("#FF0000")),
			"Standard Firearm", 3, 8, 60, 1, 6, 100);
	public static Item crossBow = new Gun("Crossbow", 8, 0, 4, Colors.get(-1,
			500, 500, Colors.fromHex("#FF0000")), "Standard Firearm", 4, 12, 8,
			10, 20, 2);
	public static Item smallSword = new Sword("Small Sword", 9, 0, 1, 0, 3,
