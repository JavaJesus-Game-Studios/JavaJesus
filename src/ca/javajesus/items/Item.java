...
public class Item {
	...
	public static Item apple = new Item("Apple", 0, 2, 5, new int[] {-1, 111,
			Colors.fromHex("#FF0000"), Colors.fromHex("#0ca101")},
			"This is a red fruit!");
	public static Item banana = new Item("Banana", 1, 3, 5, new int[] {-1, 111,
			Colors.fromHex("#fff600"), -1}, "Monkey like.");
	public static Item orange = new Item("Orange", 2, 2, 5, new int[] {-1, 111,
			Colors.fromHex("#ffae00"), Colors.fromHex("#0ca101")},
			"Orange you glad I said banana.");
	public static Item feather = new Item("Feather", 3, 4, 5, new int[] {-1,
			111, Colors.fromHex("#79b2ff"), -1}, "So light.");

	public static Item revolver = new Gun("Revolver", 4, 0, 0, new int[] {-1,
	...
	public static Item laserRevolver = new Gun("Laser Revolver", 5, 1, 0,
			new int[] {-1, 111, Colors.fromHex("#4d2607"),
					Colors.fromHex("#ffae00")}, "Standard Firearm", 1, 0, 5,
			10, 20, 75, Ammo.LASER);
	public static Item shotgun = new Gun("Shotgun", 6, 3, 0, new int[] {-1,
	...
	public static Item heavenlyShortSword = new Sword("Heavenly Short Sword",
			14, 4, 1, 0, 3, new int[] {-1, Colors.fromHex("#ebcd00"), -1,
					Colors.fromHex("#2568ff")}, "This is a sword", 0, 30, 5);
	public static Item vest = new Armor("Simple Vest", 15, 0, 0, new int[] {-1, -1,
			Colors.fromHex("#ebcd00"), Colors.fromHex("#d6d7dc")}, "",
			ArmorSet.VEST);
	public static Item knight = new Armor("Knight Gear", 16, 0, 0, new int[] {-1, -1,
			Colors.fromHex("#ebcd00"), Colors.fromHex("#d6d7dc")}, "",
			ArmorSet.KNIGHT);
	public static Item horned = new Armor("Horned Armor", 17, 0, 0, new int[] {-1, -1,
			Colors.fromHex("#ebcd00"), Colors.fromHex("#d6d7dc")}, "",
			ArmorSet.HORNED);
	public static Item owl = new Armor("Fancy Suit", 19, 0, 0, new int[] {-1, -1,
			Colors.fromHex("#ebcd00"), Colors.fromHex("#d6d7dc")}, "",
			ArmorSet.OWL);
	public static Item blackHoleGun = new Gun("Secret", 20, 0, 0, new int[] {-1,
			Colors.fromHex("#4d2607"), Colors.fromHex("#cfcfcf"),
			Colors.fromHex("#f7f7f7")}, "??????", 0, 0, 6, 10, 20, 50, Ammo.BLACKHOLE);
	public static Item flameThrower = new Gun("Flamethrower", 21, 0, 0, new int[] {-1,
            Colors.fromHex("#4d2607"), Colors.fromHex("#cfcfcf"),
